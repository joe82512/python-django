...
class VerifyCodeAdmin(admin.ModelAdmin):
    list_display = [field.name for field in VerifyCode._meta.fields] #全顯示
...
class FoodAdmin(admin.ModelAdmin):
    list_display = [field.name for field in Food._meta.fields] #全顯示
@admin.register(Drink)
class DrinkAdmin(admin.ModelAdmin):
    list_display = [field.name for field in Drink._meta.fields] #全顯示
@admin.register(Restaurant)
class RestaurantAdmin(admin.ModelAdmin):
    list_display = [field.name for field in Restaurant._meta.fields] #全顯示
@admin.register(City)
class CityAdmin(admin.ModelAdmin):
    list_display = [field.name for field in City._meta.fields] #全顯示